...
Public Class RepArqueoCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisSalud.RepArqueoCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CAJA_BSS() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRepArqueoCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepArqueoCaja = New RepArqueoCaja
        rpt.Site = Me.Site
        Return rpt
    End Function
