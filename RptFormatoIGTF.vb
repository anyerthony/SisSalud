...
Public Class RptFormatoIGTF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisSalud.RptFormatoIGTF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptFormatoIGTF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptFormatoIGTF = New RptFormatoIGTF
        rpt.Site = Me.Site
        Return rpt
    End Function
