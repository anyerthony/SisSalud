Public Class FrmPaises
    ...
    Dim adaptador As SisSalud.DataSet_IPSSTableAdapters.PAISESTableAdapter
    ...
    Private Sub FrmPaises_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        tabla = Me.DataSet_IPSS.PAISES
        source = PAISESBindingSource
        ds = source.DataSource
        adaptador = PAISESTableAdapter
