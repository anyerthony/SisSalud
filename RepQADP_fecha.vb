...
Public Class RepQADP_fecha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisSalud.RepQADP_fecha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepQADP_fecha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepQADP_fecha = New RepQADP_fecha
        rpt.Site = Me.Site
        Return rpt
    End Function
