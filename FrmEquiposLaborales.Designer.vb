...
Partial Class FrmEquiposLaborales
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmEquiposLaborales))
        ...
        Me.EQUIPOSLABORALESBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.EQUIPOS_LABORALESTableAdapter = New SisSalud.DataSet_IPSSTableAdapters.EQUIPOS_LABORALESTableAdapter
        CType(Me.DataSet_IPSS, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.EQUIPOSLABORALESBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'TextBox6
        '
        Me.TextBox6.BackColor = System.Drawing.Color.LemonChiffon
        Me.TextBox6.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.EQUIPOSLABORALESBindingSource, "id", True))
        ...
        'TextBox2
        '
        Me.TextBox2.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.EQUIPOSLABORALESBindingSource, "nombre", True))
        ...
        '
        'EQUIPOSLABORALESBindingSource
        '
        Me.EQUIPOSLABORALESBindingSource.DataMember = "EQUIPOS_LABORALES"
        Me.EQUIPOSLABORALESBindingSource.DataSource = Me.DataSet_IPSS
        '
        'EQUIPOS_LABORALESTableAdapter
        '
        Me.EQUIPOS_LABORALESTableAdapter.ClearBeforeFill = True
        '
        'FrmEquiposLaborales
        '
        ...
        Me.Name = "FrmEquiposLaborales"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Equipos Laborales"
        CType(Me.DataSet_IPSS, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.EQUIPOSLABORALESBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents EQUIPOSLABORALESBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents EQUIPOS_LABORALESTableAdapter As SisSalud.DataSet_IPSSTableAdapters.EQUIPOS_LABORALESTableAdapter
End Class
