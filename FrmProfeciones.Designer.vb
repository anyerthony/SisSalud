...
Partial Class FrmProfeciones
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmProfeciones))
        ...
        Me.PROFECIONESBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.PROFECIONESTableAdapter = New SisSalud.DataSet_IPSSTableAdapters.PROFECIONESTableAdapter
        CType(Me.DataSet_IPSS, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.PROFECIONESBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'Label1
        '
        ...
        'TextBox1
        '
        Me.TextBox1.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.PROFECIONESBindingSource, "cod_integral", True))
        ...
        Me.TextBox6.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.PROFECIONESBindingSource, "id", True))
        ...
        'TextBox2
        '
        Me.TextBox2.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.PROFECIONESBindingSource, "nombre", True))
        ...
        '
        'PROFECIONESBindingSource
        '
        Me.PROFECIONESBindingSource.DataMember = "PROFECIONES"
        Me.PROFECIONESBindingSource.DataSource = Me.DataSet_IPSS
        '
        'PROFECIONESTableAdapter
        '
        Me.PROFECIONESTableAdapter.ClearBeforeFill = True
        '
        'FrmProfeciones
        '
        ...
        Me.Name = "FrmProfeciones"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Profeciones"
        CType(Me.DataSet_IPSS, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.PROFECIONESBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents PROFECIONESBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents PROFECIONESTableAdapter As SisSalud.DataSet_IPSSTableAdapters.PROFECIONESTableAdapter
End Class
