...
Public Class Rep_ComprobanteResumido
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rep_ComprobanteResumido.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisSalud.Rep_ComprobanteResumido.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NRO_DOC() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRep_ComprobanteResumido
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rep_ComprobanteResumido = New Rep_ComprobanteResumido
        rpt.Site = Me.Site
        Return rpt
    End Function
